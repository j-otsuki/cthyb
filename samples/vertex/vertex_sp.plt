...
set output "vertex_sp.eps"
set xlabel "{/Symbol e}_{/Times-Italic n}"
set ylabel "Re {/Symbol g}(i{/Symbol e}_{/Times-Italic n}, i{/Symbol e}_{{/Times-Italic n}{/Symbol \242}}, i{/Symbol w}_{/Times-Italic m})"
set xrange[*:*]
set yrange[*:*]

set key left bottom
set label "{/Symbol e}_{{/Times-Italic n}{/Symbol \242}} = 9{/Symbol p}{/Times-Italic T}" at graph 0.7, 0.5
